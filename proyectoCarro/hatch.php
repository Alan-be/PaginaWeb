                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                    ...
                                    <div class="pi-text">
                                        <div id="Ano3" class="catagory-name">Towel</div>
                                        <a href="#">
                                            <h5 id="NombreCar3">Pure Pineapple</h5>
                                        </a>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                    ...
                                    <div class="pi-text">
                                        <div id="Ano6" class="catagory-name"></div>
                                        <a href="#">
                                            <h5 id="NombreCar6">Guangzhou sweater</h5>
                                        </a>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                        ...
                                        <div class="pi-text">
                                            <div id="Ano8" class="catagory-name"></div>
                                            <a href="#">
                                                <h5 id="NombreCar8">Guangzhou sweater</h5>
                                            </a>
