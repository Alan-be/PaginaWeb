...
<body>
   ...
   <!--  <div class="col-2 registered-users"><strong>Ingresar</strong>
            ...
            <form action="" method="post">
              ...
              <br></br>
              <button class="button create-account" type="submit">Crear una cuenta</button>
            </form>
            ...
            <div class="row">
              ...
              if($_SERVER["REQUEST_METHOD"] == "POST"){
                ...
                require_once "bd/MyQuery.php";
                  ...
                  $query-> CreateUser($_REQUEST["usuario"],$_REQUEST["password"],$_REQUEST["tipoUsuario"]);

              }
          
            ?>
                        <div class="switch-login">
                            <a href="./login.php" class="or-login">O inicia sesión</a>
                        </div>
                    </div>
                </div>
            </div>
